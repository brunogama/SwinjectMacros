...
class UserService {
    ...
    func getUser(id: String) -> User? {
        ...
        let _: User? = networkClient.fetchData(from: "users/\(id)")
...
class QuickStartAssembly: Assembly {
    func assemble(container: Container) {
        ...
        container.register(ArticleSearchServiceFactory.self) { _ in
            ArticleSearchServiceFactoryImpl(container: container)
        }
...
func runQuickStartDemo() {
    ...
    _ = Assembler([QuickStartAssembly()], container: container)
