...
public struct EnvironmentInjectMacro: AccessorMacro {
    ...
    private static func generateEnvironmentGetter(
        ...
        """).as(SourceFileSyntax.self),
              ...
              let codeBlock = functionDecl.body?.statements else {
...
private struct EnvironmentInjectMacroError: DiagnosticMessage, Error {
    let message: String
    let diagnosticID = MessageID(domain: "SwinJectMacros", id: "EnvironmentInjectError")
    let severity: DiagnosticSeverity = .error
}

private struct EnvironmentInjectMacroWarning: DiagnosticMessage {
    let message: String
    let diagnosticID = MessageID(domain: "SwinJectMacros", id: "EnvironmentInjectWarning")
