...
private struct ViewModelInjectMacroError: DiagnosticMessage, Error {
    let message: String
    let diagnosticID = MessageID(domain: "SwinJectMacros", id: "ViewModelInjectError")
    let severity: DiagnosticSeverity = .error
}

private struct ViewModelInjectMacroWarning: DiagnosticMessage {
    let message: String
    let diagnosticID = MessageID(domain: "SwinJectMacros", id: "ViewModelInjectWarning")
