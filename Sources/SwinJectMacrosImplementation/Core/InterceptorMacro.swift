...
private struct InterceptorMacroError: DiagnosticMessage {
    let message: String
    let diagnosticID = MessageID(domain: "SwinJectMacros", id: "InterceptorError")
    let severity: DiagnosticSeverity = .error
}

private struct InterceptorMacroWarning: DiagnosticMessage {
    let message: String
    let diagnosticID = MessageID(domain: "SwinJectMacros", id: "InterceptorWarning")
