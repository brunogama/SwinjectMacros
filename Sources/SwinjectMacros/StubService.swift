...
public macro StubService(
    ...
    async: Bool = true
) = #externalMacro(module: "SwinjectMacrosImplementation", type: "StubServiceMacro")
...
extension Container {
    ...
    public func registerStubs(_ registrations: [String: Any]) {
        for (typeName, _) in registrations {
            ...
            os_log(
                ...
                log: OSLog(subsystem: "com.swinjectmacros", category: "stubs"),
                type: .debug,
                typeName
            )
        }
