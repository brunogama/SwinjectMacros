...
) = #externalMacro(module: "SwinjectMacrosImplementation", type: "ValidatedContainerMacro")
...
public macro DependencyGroup(
    ...
    priority: Int = 0,
    dependencies: [String] = []
) = #externalMacro(module: "SwinjectMacrosImplementation", type: "DependencyGroupMacro")
...
public macro ServiceGroup(
    _ name: String,
    description: String = ""
) = #externalMacro(module: "SwinjectMacrosImplementation", type: "ServiceGroupMacro")
