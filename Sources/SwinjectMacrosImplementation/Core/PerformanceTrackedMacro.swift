...
private struct PerformanceTrackedMacroError: DiagnosticMessage {
    let message: String
    let diagnosticID = MessageID(domain: "SwinjectUtilityMacros", id: "PerformanceTrackedError")
    let severity: DiagnosticSeverity = .error
}

private struct PerformanceTrackedMacroWarning: DiagnosticMessage {
    let message: String
    let diagnosticID = MessageID(domain: "SwinjectUtilityMacros", id: "PerformanceTrackedWarning")
