...
public macro AutoFactory() = #externalMacro(module: "SwinjectUtilityMacrosImplementation", type: "AutoFactoryMacro")

// MARK: - Specialized Factory Macros

/// Single-parameter factory macro for services with exactly one runtime parameter
@attached(peer, names: suffixed(Factory), suffixed(FactoryImpl))
public macro AutoFactory1() = #externalMacro(module: "SwinjectUtilityMacrosImplementation", type: "AutoFactory1Macro")

/// Two-parameter factory macro for services with exactly two runtime parameters
@attached(peer, names: suffixed(Factory), suffixed(FactoryImpl))
public macro AutoFactory2() = #externalMacro(module: "SwinjectUtilityMacrosImplementation", type: "AutoFactory2Macro")
