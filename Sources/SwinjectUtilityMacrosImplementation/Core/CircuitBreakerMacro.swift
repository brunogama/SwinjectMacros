...
private struct CircuitBreakerMacroError: DiagnosticMessage {
    let message: String
    let diagnosticID = MessageID(domain: "SwinjectUtilityMacros", id: "CircuitBreakerError")
    let severity: DiagnosticSeverity = .error
}

private struct CircuitBreakerMacroWarning: DiagnosticMessage {
    let message: String
    let diagnosticID = MessageID(domain: "SwinjectUtilityMacros", id: "CircuitBreakerWarning")
