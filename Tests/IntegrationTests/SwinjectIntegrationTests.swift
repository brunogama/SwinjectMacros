...
final class SwinjectIntegrationTests: XCTestCase {
    ...
    func testNamedServices() {
        ...
        XCTAssertTrue(testClient is IntegrationMockAPIClient)
    }
    ...
    private func registerTestServices() {
        container.register(APIClient.self) { _ in IntegrationMockAPIClient() }
...
class IntegrationMockAPIClient: APIClient {
    func fetchData() -> String {
        "mock data"
    }
}
